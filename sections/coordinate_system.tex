...
\textbf{Note:} During rowing, the force at the handle is typically in the $-y$ direction, causing the oar to bend with the blade side deflecting upward relative to the handle.
\textbf{Note:} In this model, we consider bending in the horizontal plane (x–y plane). Vertical bending (along z) is neglected.
