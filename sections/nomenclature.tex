...
$\text{top}$ & Top surface of beam (tension side under downward handle load) \\
$\text{bottom}$ & Bottom surface of beam (compression side under downward handle load) \\
...
$\varepsilon_{\text{top}}$ & Strain on top surface (total strain at gauges $R_1$ and $R_2$) & -- \\
$\varepsilon_{\text{bottom}}$ & Strain on bottom surface (total strain at gauges $R_3$ and $R_4$) & -- \\
